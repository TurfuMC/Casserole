...
module.exports = {
    name: "skip",
    description: "Passer la chanson en cours",
    usage: "",
    permissions: {
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (skipTo !== null && (isNaN(skipTo) || skipTo < 1 || skipTo > player.queue.length)) return client.sendTime(interaction, "❌ | **Numéro invalide à passer !**");
            player.stop(skipTo);
            client.sendTime(interaction, "**Passer !**");
        },
    },
};
