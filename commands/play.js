...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        if (!SearchString) return client.sendTime(message.channel, `**Usage - **\`${GuildDB.prefix}play [musqiue]\``);
            ...
            if (search.match(client.Lavasfy.spotifyPattern)) {
                ...
                switch (res.loadType) {
                    ...
                    case "PLAYLIST_LOADED":
                        ...
                        await player.play();
                        let SongAdded = new MessageEmbed();
                        SongAdded.setAuthor(`Playlist ajoutée à la file d'attente`, client.config.IconURL);
